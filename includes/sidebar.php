<ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
	...
	<li class="nav-item">
		<a class="nav-link collapsed" href="profile.php" data-toggle="collapse" data-target="#collapseProfile" aria-expanded="true" aria-controls="collapseProfile">
	...
	<li class="nav-item">
		...
		<div id="collapseReferrals" class="collapse" aria-labelledby="headingReferrals" data-parent="#accordionSidebar">
			<div class="bg-white py-2 collapse-inner rounded">
				...
				<a class="collapse-item" href="genealogy.php">Genealogy</a>
