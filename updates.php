        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseReferrals">
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="register.html">My Referrals</a>
                        <!-- <a class="collapse-item" href="forgot-password.html">Pending Referrals</a>
                        <a class="collapse-item" href="forgot-password.html">Completed Referrals</a> -->
                        <div class="collapse-divider"></div>
                        <!-- <h6 class="collapse-header">Other Pages:</h6>
                        <a class="collapse-item" href="404.html">404 Page</a>
                        <a class="collapse-item" href="blank.html">Blank Page</a> -->
         ...
         <div class="col-12">
            <div class="card card-warning">
              <div class="card-header bg-info">
				<div class="row">
					<h3 class="col-md-8 text-white card-title">NEWS &amp; Updates</h3>
					<a href="/files/beta-profits-new.pdf" class="col-md-4 btn btn-success btn-sm" style="float:right; color:#fff;"><i class="fa fa-download"></i>  &nbsp; PercuniaFactorem Crowdfunding/Payment Plan</a>
				</div>
              </div>
              <!-- /.card-header -->
...
<table class="table table-striped table-bordered table-hover">
				...
				<tbody>
						...
						<td>
							Dear Members, Welcome back to Percuniafactorem. The SYSTEM UPGRADE is completed and the matrix is SECURE. We went offline to enable our developers secure the system (matrix)  against malware, bugs &amp; hacks threats. Be rest assured that PERCUNIAFACTOREM is not compromised. Wishing you an amazing holiday. 																</td>

					<!--	<td class="hidden-480">
											
<a href="/customer/news/delete/10" class="btn btn-sm btn-danger">Delete</a>
																										</td>-->
					</tr>
						...
						<td>
							Dear Members, Happy New Year (2021). Kindly upload a proof of payment (bank transfer receipt) each time you complete a donation to a peered member in your backoffice. This is a compulsory requirement for arbitration. Pass this down to your team members. Thanks, SUPPORT. 																</td>

					<!--	<td class="hidden-480">
											
<a href="/customer/news/delete/11" class="btn btn-sm btn-danger">Delete</a>
																										</td>-->
					</tr>
						...
						<td>
							Dear Members, all payments made within the percuniafactorem system MUST be accompanied with Proof of Payment - POP (bank receipt) attached.																</td>

					<!--	<td class="hidden-480">
											
<a href="/customer/news/delete/20" class="btn btn-sm btn-danger">Delete</a>
																										</td>-->
					</tr>
						...
						<td>
							Dear Members, We urge that you check that your bank details (payment processors) &amp;  personal details within your backoffice are all correct. Betaprofitss will not take responsibility for missing payments nor misrepresentations due to this negligence. Thanks, SUPPORT. 																</td>

					<!--	<td class="hidden-480">
											
<a href="/customer/news/delete/21" class="btn btn-sm btn-danger">Delete</a>
																										</td>-->
					</tr>
						...
						<td>
							Dear Members, DO NOT fail to upload a Proof of Payment (local bank transfer receipt) each time you complete a donation to a PEERED member in your backoffice. This is a compulsory requirement for arbitration. Thanks, SUPPORT.																</td>

					<!--	<td class="hidden-480">
											
<a href="/customer/news/delete/22" class="btn btn-sm btn-danger">Delete</a>
																										</td>-->
					</tr>
